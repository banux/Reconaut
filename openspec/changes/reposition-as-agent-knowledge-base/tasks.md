...
- [ ] **1.1 Réécrire `openspec/project.md`**
...
- [ ] **1.2 Mettre à jour `init-reconaut-platform/proposal.md`**
...
- [ ] **1.3 Mettre à jour `single-user-only/proposal.md`**
...
- [ ] **1.4 Documenter le positionnement « base de connaissance pour agents »**
...
- [ ] **2.1 Implémenter `ingest_scan_result` dans `Mcp::CoreTools`**
...
- [ ] **2.2 Service `Reconaut::ScanResultIngestor`**
...
- [ ] **2.3 Tagging `source` sur les rows ingérées**
...
- [ ] **2.4 Mise à jour `MCP::ToolsController` / liste des tools exposés**
...
- [ ] **3.1 Page `docs/integrations/external-scanners.md`**
...
- [ ] **3.2 Mention du repositionnement dans `README.md`**
...
- [ ] **4.1 Tests automatisés `ingest_scan_result`**
  - Au moins quatre specs : happy path, hors scope, payload invalide, idempotence par `idempotency_key`.

- [ ] **4.2 Source tagging vérifiable via les outils de lecture**
...
- [ ] **4.4 La routine `system_doctor` reste cohérente**
