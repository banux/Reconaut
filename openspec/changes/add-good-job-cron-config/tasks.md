...
- [x] **1.1 `config/initializers/good_job.rb`**
...
- [x] **1.2 Spec `spec/config/good_job_config_spec.rb`**
...
- [x] **2.1 `docs/operating/deployment-docker-compose.md`**
...
- [x] **2.2 `docs/operating/deployment-helm.md`**
...
- [x] **2.3 `docs/architecture/remote-scanners.md`**
