...
- [ ] **1.1 Catalogue de tools MCP étendu**
...
- [ ] **1.2 Streaming `agent_chat` via tool_result partiels**
...
- [ ] **1.3 Matrice de scopes RBAC mise à jour**
...
- [ ] **2.2 Endpoint `GET /healthz` non authentifié**
...
- [ ] **2.3 Auth bootstrap REST stabilisé**
...
- [ ] **2.4 Marquer les controllers REST hérités comme `@deprecated`**
...
- [ ] **3.1 Client MCP Go embarqué dans `apps/tui/`**
...
- [ ] **3.2 Sous-commandes TUI passent par MCP**
...
- [ ] **3.3 Linter sur les chemins HTTP appelés par la TUI**
...
- [ ] **4.1 Mettre à jour `replace-web-with-tui`**
...
- [ ] **4.2 Mettre à jour `openspec/project.md`**
...
- [ ] **4.3 Documenter la migration des controllers REST hérités**
...
- [ ] **5.1 Tests automatisés pour chaque outil MCP étendu**
...
- [ ] **5.5 Une seule clé API sert TUI et un agent IA**
