...
- [ ] **1.1 Package `apps/scanner/internal/modbusprobe/`**
...
- [ ] **1.2 Faux serveur Modbus TCP de test (in-process)**
...
- [ ] **2.1 Handler dispatch vers modbusprobe quand port=502**
...
- [ ] **2.2 ENV vars `RECONAUT_MODBUS_PROBE_*`**
...
- [ ] **3.1 `docs/architecture/scan-frontier.md`**
...
- [ ] **3.3 Cocher §2.5 dans `openspec/changes/init-reconaut-platform/tasks.md`**
