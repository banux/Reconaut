...
- [ ] **1.1 Scopes `worker:claim` et `worker:submit` enregistrés**
...
- [ ] **1.3 Use case `Scanner::SubmitResult`**
...
- [ ] **1.5 3 tools MCP enregistrés dans `core_tools.rb`**
...
- [ ] **1.6 Recurring job de lease release**
...
- [ ] **2.1 Nouveau package `internal/agentclient/`**
...
- [ ] **2.2 Refactor `internal/runtime/runtime.go` → agentLoop**
...
- [ ] **2.3 Supprimer `internal/results/sql.go` et `sql_test.go`**
...
- [ ] **2.4 Supprimer `internal/goodjob/sql.go`**
...
- [ ] **2.6 Adapter chaque main `cmd/scanner-<kind>/main.go`**
...
- [ ] **3.1 `scripts/check_scanner_no_db_access.sh`**
...
- [ ] **3.2 Wired dans `.github/workflows/ci.yml`**
...
- [ ] **4.1 Mettre à jour `scripts/check_scanner_deps_licenses.sh`**
...
- [ ] **5.1 Helm chart : pods scanner sans Secret DB**
...
- [ ] **5.2 docker-compose : drop dépendance Postgres pour scanner-***
...
- [ ] **6.1 `docs/architecture/scan-frontier.md`**
...
- [ ] **6.2 `docs/operating/deployment-helm.md`** et **`deployment-docker-compose.md`**
...
- [ ] **6.3 Nouvelle doc `docs/architecture/remote-scanners.md`**
...
- [ ] **7.1 Archive `openspec/changes/add-scanner-pgx-driver/` → `openspec/archive/`**
