...
- [ ] **1.1 Ajouter la dépendance `github.com/jackc/pgx/v5/stdlib`**
...
- [ ] **1.2 Blank import dans `internal/runtime/runtime.go`**
...
- [ ] **1.3 `runtime.wireStores()` bascule sur SQL par défaut**
...
- [ ] **2.1 Implémenter `apps/scanner/internal/results/sql.go`**
...
- [ ] **2.2 Ajouter `github.com/DATA-DOG/go-sqlmock` aux deps de test**
...
- [ ] **3.1 Créer `apps/api/db/migrate/<ts>_create_scan_results.rb`**
...
- [ ] **3.2 Mettre à jour `db/structure.sql` si présent**
...
- [ ] **4.1 Mettre à jour `scripts/check_license_audit.sh` (ou équivalent)**
...
- [ ] **4.2 Vérifier `scripts/check_no_billing.sh` n'est pas faussement positif**
...
- [ ] **5.1 Mettre à jour `docs/operating/deployment-helm.md` et `deployment-docker-compose.md`**
...
- [ ] **5.2 Mettre à jour `docs/architecture/scan-frontier.md`**
