...
- [x] **1.1 Package `apps/scanner/internal/rdpprobe/`**
...
- [x] **1.2 Faux serveur RDP de test (in-process)**
...
- [x] **2.1 Handler dispatch vers rdpprobe quand port=3389**
...
- [x] **2.2 Variables d'environnement `RECONAUT_RDP_PROBE_*`**
